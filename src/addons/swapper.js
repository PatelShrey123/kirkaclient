...
const initResourceSwapper = () => {
  protocol.registerFileProtocol("kirkaxpertclient", (request, callback) =>
    callback({ path: request.url.replace("kirkaxpertclient://", "") })
  );
  ...
  let folder_regex_generator = "KirkaXpert[\\\\/]swapper[\\\\/]assets[\\\\/](";
